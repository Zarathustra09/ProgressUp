...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <button type="button" class="btn btn-primary mb-3" id="addRecord" onclick="createStaff()">
            <span class="tf-icons bx bx-plus"></span>&nbsp; Add Staff
        </button>
...
{{--                            </a>--}}
                            ...
                            <a href="javascript:void(0)" onclick="deleteStaff({{ $user->id }})" class="text-danger me-2">
        ...
        function editStaff(id) {
            $.ajax({
                ...
                error: function() {
                    Swal.fire({
                        title: '<h4 class="fw-bold text-danger">Error!</h4>',
                        text: 'There was an error fetching the staff details.',
                        icon: 'error',
                        customClass: {
                            popup: 'rounded shadow-lg',
                            confirmButton: 'btn btn-danger btn-block'
