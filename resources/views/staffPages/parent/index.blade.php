    ...
    <script>
        ...
        function createUser() {
            ...
            `,
                ...
                preConfirm: () => {
                    ...
                    return { first_name, middle_name, last_name, email, phone_number, address, province, birthdate, password, password_confirmation };
                }
            }).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('staffParent.store') }}',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            ...result.value
        ...
        function editUser(id) {
            $.ajax({
                ...
                `,
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: '{{ route('staffParent.update', '') }}/' + id,
                                type: 'PUT',
                                data: {
                                    _token: '{{ csrf_token() }}',
                                    ...result.value
        ...
        function deleteUser(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('staffParent.destroy', '') }}/' + id,
                        type: 'DELETE',
